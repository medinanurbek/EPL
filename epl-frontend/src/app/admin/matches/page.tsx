...
import { Match, Team, MatchStatus, EventType } from "@/types";
import { Plus, Calendar, Edit2, Play, CheckCircle, ArrowLeft, Trophy, X, Check, Timer } from "lucide-react";
        ...
        <div className="py-12 bg-slate-50 min-h-screen font-inter">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <header className="mb-12 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div>
                        <Link href="/admin" className="inline-flex items-center gap-2 text-[#37003c]/40 hover:text-[#37003c] mb-4 transition-colors text-[10px] font-black uppercase tracking-widest">
                                ...
                                <div className="flex-1 flex items-center justify-between w-full max-w-2xl mx-auto">
                                    <div className="flex flex-col items-center gap-4 w-32">
                                        <div className="relative w-16 h-16 transition-transform group-hover:scale-110">
                                            <Image src={getTeamLogo(home?.name || "")} alt="logo" fill className="object-contain" />
                                        </div>
                                    ...
                                    <div className="flex flex-col items-center gap-4 w-32">
                                        <div className="relative w-16 h-16 transition-transform group-hover:scale-110">
                                            <Image src={getTeamLogo(away?.name || "")} alt="logo" fill className="object-contain" />
                                        </div>
