        ...
        <div className="bg-white min-h-screen">
            ...
            <div className="bg-[#37003c] text-white pt-24 pb-48 relative overflow-hidden">
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
                    <Link to={`/teams/${mockPlayer.teamId}`} className="inline-flex items-center gap-2 text-white/50 hover:text-[#00ff85] mb-8 transition-colors text-[10px] font-black uppercase tracking-widest">
