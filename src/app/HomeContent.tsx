                        ...
                        >
                            <div className="glass-card bg-[#37003c]/80 backdrop-blur-xl p-8 rounded-[2rem] border border-white/10 shadow-2xl relative overflow-hidden">
                                ...
                                <div className="flex items-center justify-between mb-8 relative z-10">
                                    ...
                                    <Link href="/standings" className="text-[#04f5ff] text-[10px] font-outfit font-black uppercase tracking-[0.2em] hover:text-white transition-colors">View Table</Link>
                                </div>
                        ...
                        <div className="lg:col-span-2 space-y-12">
                            ...
                            <section>
                                <div className="flex items-center justify-between mb-8">
                                    ...
                                    <Link href="/matches" className="text-[10px] font-outfit font-black text-[#ff2882] uppercase tracking-widest hover:text-[#00ff85] transition-colors">See All</Link>
                                </div>
