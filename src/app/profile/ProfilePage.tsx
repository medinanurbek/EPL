                ...
                <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row items-center gap-8">
                        ...
                        <div className="text-center md:text-left flex-1 space-y-4">
                            <div>
                                <h1 className="text-4xl md:text-6xl font-outfit font-black text-white uppercase tracking-tighter mb-2 italic">
                                    {user?.fullName || "Premier Guest"}
                                </h1>
                                <p className="text-[#00ff85] font-outfit font-black uppercase text-xs tracking-[0.4em]">Official Fan Profile</p>
                            </div>

                            <button
                                onClick={handleLogout}
                                className="px-8 py-4 bg-red-500/10 hover:bg-red-500 text-red-500 hover:text-white border border-red-500/20 rounded-2xl font-outfit font-black uppercase text-[10px] tracking-[0.2em] transition-all flex items-center gap-3 w-fit mx-auto md:mx-0 shadow-lg shadow-red-500/10"
                            >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-8">
                            <div className="flex items-center justify-between">
                                <h2 className="text-[10px] font-outfit font-black text-white/40 uppercase tracking-[0.5em] flex items-center gap-4 w-full">
                                    Favorite Clubs
                            ...
                            <div className="grid gap-4">
                                <AnimatePresence>
                                    {favoriteTeamsData.map((team) => (
                                        <motion.div
                                            ...
                                            className="bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-[2.5rem] flex items-center gap-6 group hover:bg-white/10 transition-all"
                                        >
                                            ...
                                            <div className="flex-1">
                                                <h3 className="text-lg font-outfit font-black text-white uppercase tracking-tight">{team.name}</h3>
                                                <div className="flex items-center gap-2 text-[10px] font-outfit font-bold text-white/40 uppercase tracking-widest mt-1">
                                ...
                                {favoriteTeamsData.length === 0 && (
                                    <div className="py-16 bg-white/5 rounded-[3rem] border-2 border-dashed border-white/10 flex flex-col items-center justify-center text-center">
                                        <Shield className="w-10 h-10 text-white/10 mb-4" />
                                        <p className="text-sm font-outfit font-black text-white/40 uppercase tracking-[0.2em]">No clubs followed</p>
                                        <Link href="/teams" className="text-[10px] font-outfit font-black text-[#00ff85] uppercase tracking-widest mt-6 hover:underline">Pick a team</Link>
                                    </div>
                                )}
                            </div>
                        </div>
                            ...
                            <div className="grid gap-4">
                                    ...
                                    {favoritePlayersData.map((player) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 text-white">
                                                <h3 className="text-lg font-outfit font-black uppercase tracking-tight truncate w-32">{player.name}</h3>
                                                <div className="flex items-center gap-2 text-[10px] font-outfit font-bold text-[#ff005a] uppercase tracking-widest mt-1">
                                ...
                                {favoritePlayersData.length === 0 && (
                                    <div className="py-16 bg-white/5 rounded-[3rem] border-2 border-dashed border-white/10 flex flex-col items-center justify-center text-center">
                                        ...
                                        <p className="text-sm font-outfit font-black text-white/40 uppercase tracking-[0.2em]">No players followed</p>
                                        <Link href="/stats" className="text-[10px] font-outfit font-black text-[#ff005a] uppercase tracking-widest mt-6 hover:underline">Find a star</Link>
                                    </div>
                                )}
                            </div>
                        </div>
